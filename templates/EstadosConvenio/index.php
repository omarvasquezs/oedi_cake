...
<div class="estados-convenio-index">
    ...
    <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem;">
        <div style="flex: 1; position: relative;">
            <input type="text" placeholder="Buscar estados de convenio..." style="width: 100%; padding: 0.7rem 1rem 0.7rem 2.5rem; border: 1px solid #ddd; border-radius: 4px; font-size: 14px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr style="background: #f8f9fa; border-bottom: 2px solid #e0e0e0;">
                    <th style="padding: 1rem; text-align: left; font-size: 13px; color: #666; font-weight: 600; text-transform: uppercase;">ID</th>
            ...
            <tbody>
                <tr>
                    <td colspan="3" style="padding: 3rem; text-align: center; color: #95a5a6; font-size: 14px;">
                        No hay estados de convenio disponibles
                    </td>
                </tr>
            </tbody>
        </table>
