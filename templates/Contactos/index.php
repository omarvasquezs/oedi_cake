 ...
 */
$this->assign('title', $title ?? 'Contactos');
?>
...
<div class="contactos-index">
    ...
    <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem;">
        <div style="flex: 1; position: relative;">
            <input type="text" placeholder="Buscar contactos..." style="width: 100%; padding: 0.7rem 1rem 0.7rem 2.5rem; border: 1px solid #ddd; border-radius: 4px; font-size: 14px;">
    ...
    <div style="background: white; border-radius: 8px; border: 1px solid #e0e0e0; overflow: hidden;">
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                <tr>
                    <td colspan="7" style="padding: 3rem; text-align: center; color: #95a5a6; font-size: 14px;">
