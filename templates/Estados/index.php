...
<div class="estados-index">
    ...
    <div style="display:flex;gap:1rem;margin-bottom:1.5rem;">
        <div style="flex:1;" id="mainSearchContainer" <?= (!empty($filterDescripcion)) ? 'hidden' : '' ?>>
            <form method="get" action="<?= $this->Url->build(['controller' => 'Estados', 'action' => 'index']) ?>" id="searchForm" class="input-with-icon">
                ...
                <?php if (!empty($search)): ?>
                    <a href="<?= $this->Url->build(['controller' => 'Estados', 'action' => 'index', '?' => ['per_page' => $perPage]]) ?>" class="input-clear" title="Limpiar búsqueda"><i class="fa-solid fa-times"></i></a>
                <?php endif; ?>
            </form>
        </div>
                        ...
                        <tr style="border-bottom:1px solid #f0f0f0;">
                            ...
                            <td style="padding:1rem;vertical-align:middle;">
                                <div style="display:flex;align-items:center;gap:0.75rem;">
                                    ...
                                    <?= $this->Form->postLink('<i class="fa-solid fa-trash icon-delete"></i>', ['action' => 'delete', $e->id_estado], ['confirm' => "¿Está seguro de eliminar este estado?", 'class' => 'action-icon', 'escape' => false, 'title' => 'Eliminar']) ?>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
...
<div class="modal fade" id="addEstadoModal" tabindex="-1" aria-labelledby="addEstadoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?= $this->Form->create(null, ['url' => ['controller' => 'Estados', 'action' => 'add']]) ?>
...
<div class="modal fade" id="editEstadoModal" tabindex="-1" aria-labelledby="editEstadoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?= $this->Form->create(null, ['id' => 'editEstadoForm', 'url' => ['controller' => 'Estados', 'action' => 'edit']]) ?>
            <div class="modal-header">
