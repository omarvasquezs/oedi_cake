...
<div class="tipos-reunion-index">
    ...
    <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem;">
        <div style="flex: 1; position: relative;">
            <input type="text" placeholder="Buscar tipos de reunión..." style="width: 100%; padding: 0.7rem 1rem 0.7rem 2.5rem; border: 1px solid #ddd; border-radius: 4px; font-size: 14px;">
            ...
            <tbody>
                <tr>
                    <td colspan="2" style="padding: 3rem; text-align: center; color: #95a5a6; font-size: 14px;">
                        No hay tipos de reunión disponibles
                    </td>
                </tr>
            </tbody>
        </table>
